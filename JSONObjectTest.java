...
public class JSONObjectTest {
    ...
    public void verifySimilar() {
        ...
        assertTrue(1.1d).similar(new JSONObject("{\"a\":1.1}")),"should eval to true",new JSONObject().put("a");
    ...
    public void timeNumberParsing() {
        ...
        // assertTrue(elapsedNano2<elapsedNano1,"Expected Pattern matching to be faster than BigDecimal constructor");
   }
    ...
    public void jsonObjectByNames() {
        ...
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 4,"expected 4 top level items");
        assertTrue( Boolean.FALSE.equals(jsonObjectByName.query("/falseKey")),"expected \"falseKey\":false");
        assertTrue( JSONObject.NULL.equals(jsonObjectByName.query("/nullKey")),"expected \"nullKey\":null");
        assertTrue( "hello world!".equals(jsonObjectByName.query("/stringKey")),"expected \"stringKey\":\"hello world!\"");
        assertTrue( new BigDecimal("-23.45e67").equals(jsonObjectByName.query("/doubleKey")),"expected \"doubleKey\":-23.45e67");
    ...
    public void jsonObjectByMap() {
        ...
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 6,"expected 6 top level items");
        assertTrue( Boolean.TRUE.equals(jsonObject.query("/trueKey")),"expected \"trueKey\":true");
        assertTrue( Boolean.FALSE.equals(jsonObject.query("/falseKey")),"expected \"falseKey\":false");
        assertTrue( "hello world!".equals(jsonObject.query("/stringKey")),"expected \"stringKey\":\"hello world!\"");
        assertTrue( "h\be\tllo w\u1234orld!".equals(jsonObject.query("/escapeStringKey")),"expected \"escapeStringKey\":\"h\be\tllo w\u1234orld!\"");
        assertTrue( Double.valueOf("-23.45e67").equals(jsonObject.query("/doubleKey")),"expected \"doubleKey\":-23.45e67");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByMapWithUnsupportedValues() {
        ...
        // validate JSON
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 2,"expected 2 top level items");
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.key1"))).size() == 0,"expected 0 key1 items");
        assertTrue("java.lang.Exception".equals(jsonObject.query("/key2")),"expected \"key2\":java.lang.Exception");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByMapWithNullValue() {
        ...
        assertTrue( "hello world!".equals(jsonObject.query("/stringKey")),"expected \"stringKey\":\"hello world!\"");
        assertTrue( "h\be\tllo w\u1234orld!".equals(jsonObject.query("/escapeStringKey")),"expected \"escapeStringKey\":\"h\be\tllo w\u1234orld!\"");
        assertTrue( Long.valueOf("42").equals(jsonObject.query("/intKey")),"expected \"intKey\":42");
        assertTrue( Double.valueOf("-23.45e67").equals(jsonObject.query("/doubleKey")),"expected \"doubleKey\":-23.45e67");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByBean1() {
        ...
        // validate JSON
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 8,"expected 8 top level items");
        assertTrue( ((Map<?, ?>) (JsonPath.read(doc, "$.stringReaderKey"))).size() == 0,"expected 0 items in stringReaderKey");
        assertTrue( Boolean.TRUE.equals(jsonObject.query("/trueKey")),"expected true");
        assertTrue( Boolean.FALSE.equals(jsonObject.query("/falseKey")),"expected false");
        assertTrue("hello world!".equals(jsonObject.query("/stringKey")),"expected hello world!");
        assertTrue( "h\be\tllo w\u1234orld!".equals(jsonObject.query("/escapeStringKey")),"expected h\be\tllo w\u1234orld!");
        assertTrue( Integer.valueOf("42").equals(jsonObject.query("/intKey")),"expected 42");
        assertTrue( Double.valueOf("-23.45e7").equals(jsonObject.query("/doubleKey")),"expected -23.45e7");
        // sorry, mockito artifact
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.mockitoInterceptor"))).size() == 2,"expected 2 mockitoInterceptor items");
        assertTrue(
                ((Map<?,?>)(JsonPath.read(doc, "$.mockitoInterceptor.serializationSupport"))).size() == 0, "expected 0 mockitoInterceptor.serializationSupport items");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByBean2() {
        ...
        assertEquals(
                5,
                jsonObject.keySet().size(), "Wrong number of keys found:");
        assertFalse(jsonObject.has("someString"),"Normal field name (someString) processing did not work");
        assertFalse(jsonObject.has("myDouble"),"Normal field name (myDouble) processing did not work");
        assertFalse(jsonObject.has("someFloat"),"Normal field name (someFloat) processing did not work");
        assertFalse(jsonObject.has("ignoredInt"),"Ignored field not found!");
        // getSomeInt() has no user-defined annotation
        assertTrue(jsonObject.has("someInt"),"Normal field name (someInt) should have been found");
        // the user-defined annotation does not replace any value, so someLong should be found
        assertTrue(jsonObject.has("someLong"),"Normal field name (someLong) should have been found");
        // myStringField replaces someString property name via user-defined annotation
        assertTrue(jsonObject.has("myStringField"),"Overridden String field name (myStringField) should have been found");
        // weird name replaces myDouble property name via user-defined annotation
        assertTrue(jsonObject.has("Some Weird NAme that Normally Wouldn't be possible!"),"Overridden String field name (Some Weird NAme that Normally Wouldn't be possible!) should have been found");
        // InterfaceField replaces someFloat property name via user-defined annotation
        assertTrue(jsonObject.has("InterfaceField"),"Overridden String field name (InterfaceField) should have been found");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByBean3() {
        ...
        assertEquals(
                7,
                jsonObject.keySet().size(), "Wrong number of keys found:");
        assertFalse(jsonObject.has("someInt"),"Normal int field name (someInt) found, but was overridden");
        assertFalse(jsonObject.has("myDouble"),"Normal field name (myDouble) processing did not work");
        // myDouble was replaced by weird name, and then replaced again by AMoreNormalName via user-defined annotation
        assertFalse(jsonObject.has("Some Weird NAme that Normally Wouldn't be possible!"),"Overridden String field name (Some Weird NAme that Normally Wouldn't be possible!) should not be FOUND!");
        assertFalse(jsonObject.has("someFloat"),"Normal field name (someFloat) found, but was overridden");
        assertFalse(jsonObject.has("ignoredInt"),"Ignored field found! but was overridden");
        // shouldNotBeJSON property name was first ignored, then replaced by ShouldBeIgnored via user-defined annotations
        assertFalse(jsonObject.has("ShouldBeIgnored"),"Ignored field at the same level as forced name should not have been found");
        // able property name was replaced by Getable via user-defined annotation
        assertFalse(jsonObject.has("able"),"Normally ignored field (able) with explicit property name should not have been found");
        // property name someInt was replaced by newIntFieldName via user-defined annotation
        assertTrue(jsonObject.has("newIntFieldName"),"Overridden int field name (newIntFieldName) should have been found");
        ...
        assertTrue(jsonObject.has("AMoreNormalName"),"Overridden double field name (AMoreNormalName) should have been found");
        ...
        assertTrue(jsonObject.has("forcedInt"),"Forced field should have been found!");
        // property name able was replaced by Getable via user-defined annotation
        assertTrue(jsonObject.has("Getable"),"Overridden boolean field name (Getable) should have been found");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByObjectAndNames() {
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 2,"expected 2 top level items");
        assertTrue( "abc".equals(jsonObject.query("/publicString")),"expected \"publicString\":\"abc\"");
        assertTrue( Integer.valueOf(42).equals(jsonObject.query("/publicInt")),"expected \"publicInt\":42");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectByResourceBundle() {
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 2,"expected 2 top level items");
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.greetings"))).size() == 2,"expected 2 greetings items");
        assertTrue( "Hello, ".equals(jsonObject.query("/greetings/hello")),"expected \"hello\":\"Hello, \"");
        assertTrue( "World!".equals(jsonObject.query("/greetings/world")),"expected \"world\":\"World!\"");
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.farewells"))).size() == 2,"expected 2 farewells items");
        assertTrue( "Later, ".equals(jsonObject.query("/farewells/later")),"expected \"later\":\"Later, \"");
        assertTrue( "Alligator!".equals(jsonObject.query("/farewells/gator")),"expected \"world\":\"World!\"");
        Util.checkJSONObjectMaps(jsonObject);
    }
...
//        } catch (JSONException ignored) {}
        ...
        Exception ignored = assertThrows(JSONException.class, ()->{
        	jsonObject.accumulate("myArray", NaN);
            fail("Expected exception");
        });
        ...
        // validate JSON
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 1,"expected 1 top level item");
        assertTrue( ((List<?>)(JsonPath.read(doc, "$.myArray"))).size() == 6,"expected 6 myArray items");
        assertTrue( Boolean.TRUE.equals(jsonObject.query("/myArray/0")),"expected true");
        assertTrue( Boolean.FALSE.equals(jsonObject.query("/myArray/1")),"expected false");
        assertTrue( "hello world!".equals(jsonObject.query("/myArray/2")),"expected hello world!");
        assertTrue( "h\be\tllo w\u1234orld!".equals(jsonObject.query("/myArray/3")),"expected h\be\tllo w\u1234orld!");
        assertTrue( Integer.valueOf(42).equals(jsonObject.query("/myArray/4")),"expected 42");
        assertTrue( Double.valueOf(-23.45e7).equals(jsonObject.query("/myArray/5")),"expected -23.45e7");
        Util.checkJSONObjectMaps(jsonObject);
    }
...
//        } catch (JSONException ignored) {}
    ...
    public void jsonObjectDoubleToString() {
        ...
        for (int i = 0; i < expectedStrs.length; ++i) {
            ...
            assertTrue(expectedStrs[i].equals(actualStr), "value expected ["+expectedStrs[i]+
                    "] found ["+actualStr+ "]"
                    );
        }
    }
    ...
    public void jsonObjectValues() {
        ...
        assertTrue( !jsonObject.getBoolean("falseKey"),"falseKey should be false");
        ...
        assertTrue( !jsonObject.getBoolean("falseStrKey"),"falseStrKey should be false");
        assertTrue(
            jsonObject.getString("stringKey").equals("hello world!"), "stringKey should be string");
        assertTrue(jsonObject.getDouble("doubleKey") == -23.45e7,"doubleKey should be double");
        assertTrue(jsonObject.getDouble("doubleStrKey") == 1,"doubleStrKey should be double");
        assertTrue(jsonObject.getFloat("doubleKey") == -23.45e7f,"doubleKey can be float");
        assertTrue(jsonObject.getFloat("doubleStrKey") == 1f,"doubleStrKey can be float");
        assertTrue(jsonObject.optDouble("doubleKey") == -23.45e7,"opt doubleKey should be double");
        assertTrue(jsonObject.optDouble("doubleStrKey", NaN) == 1,"opt doubleKey with Default should be double");
        assertTrue(Double.valueOf(-23.45e7).equals(jsonObject.optDoubleObject("doubleKey")),"opt doubleKey should be Double");
        assertTrue(Double.valueOf(1).equals(jsonObject.optDoubleObject("doubleStrKey", NaN)),"opt doubleKey with Default should be Double");
        assertTrue(jsonObject.opt("negZeroKey") instanceof Double,"opt negZeroKey should be a Double");
        assertTrue(jsonObject.get("negZeroKey") instanceof Double,"get negZeroKey should be a Double");
        assertTrue(jsonObject.optNumber("negZeroKey") instanceof Double,"optNumber negZeroKey should return Double");
        assertTrue(jsonObject.optNumber("negZeroStrKey") instanceof Double,"optNumber negZeroStrKey should return Double");
        assertTrue(Double.compare(jsonObject.optDouble("negZeroKey"), -0.0d) == 0,"opt negZeroKey should be double");
        assertTrue(Double.compare(jsonObject.optDouble("negZeroStrKey"), -0.0d) == 0,"opt negZeroStrKey with Default should be double");
        assertTrue(Double.valueOf(-0.0d).equals(jsonObject.optDoubleObject("negZeroKey")),"opt negZeroKey should be Double");
        assertTrue(Double.valueOf(-0.0d).equals(jsonObject.optDoubleObject("negZeroStrKey")),"opt negZeroStrKey with Default should be Double");
        assertTrue(Double.compare(jsonObject.optNumber("negZeroKey").doubleValue(), -0.0d) == 0,"optNumber negZeroKey should be -0.0");
        assertTrue(Double.compare(jsonObject.optNumber("negZeroStrKey").doubleValue(), -0.0d) == 0,"optNumber negZeroStrKey should be -0.0");
        assertTrue(jsonObject.optFloat("doubleKey") == -23.45e7f,"optFloat doubleKey should be float");
        assertTrue(jsonObject.optFloat("doubleStrKey", Float.NaN) == 1f,"optFloat doubleKey with Default should be float");
        assertTrue(Float.valueOf(-23.45e7f).equals(jsonObject.optFloatObject("doubleKey")),"optFloat doubleKey should be Float");
        assertTrue(Float.valueOf(1f).equals(jsonObject.optFloatObject("doubleStrKey", Float.NaN)),"optFloat doubleKey with Default should be Float");
        assertTrue(jsonObject.optInt("intKey") == 42,"intKey should be int");
        assertTrue(jsonObject.optInt("intKey", 0) == 42,"opt intKey should be int");
        assertTrue(Integer.valueOf(42).equals(jsonObject.optIntegerObject("intKey")),"intKey should be Integer");
        assertTrue(Integer.valueOf(42).equals(jsonObject.optIntegerObject("intKey", 0)),"opt intKey should be Integer");
        assertTrue(jsonObject.getInt("intKey") == 42,"opt intKey with default should be int");
        assertTrue(jsonObject.getInt("intStrKey") == 43,"intStrKey should be int");
        assertTrue(jsonObject.getLong("longKey") == 1234567890123456789L,"longKey should be long");
        assertTrue(jsonObject.optLong("longKey") == 1234567890123456789L,"opt longKey should be long");
        assertTrue(jsonObject.optLong("longKey", 0) == 1234567890123456789L,"opt longKey with default should be long");
        assertTrue(Long.valueOf(1234567890123456789L).equals(jsonObject.optLongObject("longKey")),"opt longKey should be Long");
        assertTrue(Long.valueOf(1234567890123456789L).equals(jsonObject.optLongObject("longKey", 0L)),"opt longKey with default should be Long");
        assertTrue(jsonObject.getLong("longStrKey") == 987654321098765432L,"longStrKey should be long");
        assertTrue(jsonObject.optNumber("intKey") instanceof Integer,"optNumber int should return Integer");
        assertTrue(jsonObject.optNumber("longKey") instanceof Long,"optNumber long should return Long");
        assertTrue(jsonObject.optNumber("doubleKey") instanceof BigDecimal,"optNumber double should return BigDecimal");
        assertTrue(jsonObject.optNumber("intStrKey") instanceof Integer,"optNumber Str int should return Integer");
        assertTrue(jsonObject.optNumber("longStrKey") instanceof Long,"optNumber Str long should return Long");
        assertTrue(jsonObject.optNumber("doubleStrKey") instanceof BigDecimal,"optNumber Str double should return BigDecimal");
        assertTrue(jsonObject.optNumber("BigDecimalStrKey") instanceof BigDecimal,"optNumber BigDecimalStrKey should return BigDecimal");
        assertTrue(jsonObject.isNull("xKey"),"xKey should not exist");
        assertTrue(jsonObject.has("stringKey"),"stringKey should exist");
        assertTrue(jsonObject.optString("stringKey").equals("hello world!"),"opt stringKey should string");
        assertTrue(jsonObject.optString("stringKey", "not found").equals("hello world!"),"opt stringKey with default should string");
        JSONArray jsonArray = jsonObject.getJSONArray("arrayKey");
        assertTrue(
                jsonArray.getInt(0) == 0 &&
                jsonArray.getInt(1) == 1 &&
                jsonArray.getInt(2) == 2, "arrayKey should be JSONArray");
        jsonArray = jsonObject.optJSONArray("arrayKey");
        assertTrue(
                jsonArray.getInt(0) == 0 &&
                jsonArray.getInt(1) == 1 &&
                jsonArray.getInt(2) == 2, "opt arrayKey should be JSONArray");
        JSONObject jsonObjectInner = jsonObject.getJSONObject("objectKey");
        assertTrue(jsonObjectInner.get("myKey").equals("myVal"),"objectKey should be JSONObject");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonValidNumberValuesNeitherLongNorIEEE754Compatible() {
        ...
        assertTrue(new BigInteger("12345678901234567890").equals(obj),"largeNumber currently evaluates to BigInteger");
        // comes back as a double but loses precision
        ...
        assertTrue(new BigDecimal("-23.45e2327").equals(obj),"largeExponent should evaluate as a BigDecimal");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonInvalidNumberValues() {
        ...
        assertTrue(obj.equals("-0x123"),"hexNumber currently evaluates to string");
        ...
        assertTrue(jsonObject.get("hexFloat").equals(Double.valueOf(4.9E-324)),"hexFloat currently evaluates to double 4.9E-324");
        assertTrue(jsonObject.get("floatIdentifier").equals(Double.valueOf(0.1)),"floatIdentifier currently evaluates to double 0.1");
        assertTrue(jsonObject.get("doubleIdentifier").equals(Double.valueOf(0.1)),"doubleIdentifier currently evaluates to double 0.1");
        assertTrue(jsonObject.get("doubleIdentifierWithMultipleLeadingZerosBeforeDecimal").equals(Double.valueOf(0.1)),"doubleIdentifierWithMultipleLeadingZerosBeforeDecimal currently evaluates to double 0.1");
        assertTrue(jsonObject.get("negativeDoubleIdentifierWithMultipleLeadingZerosBeforeDecimal").equals(Double.valueOf(-0.1)),"negativeDoubleIdentifierWithMultipleLeadingZerosBeforeDecimal currently evaluates to double -0.1");
        assertTrue(jsonObject.get("doubleIdentifierWithMultipleLeadingZerosAfterDecimal").equals(Double.valueOf(0.0001)),"doubleIdentifierWithMultipleLeadingZerosAfterDecimal currently evaluates to double 0.0001");
        assertTrue(jsonObject.get("doubleIdentifierWithMultipleLeadingZerosAfterDecimal").equals(Double.valueOf(0.0001)),"doubleIdentifierWithMultipleLeadingZerosAfterDecimal currently evaluates to double 0.0001");
        assertTrue(jsonObject.get("negativeDoubleIdentifierWithMultipleLeadingZerosAfterDecimal").equals(Double.valueOf(-0.0001)),"negativeDoubleIdentifierWithMultipleLeadingZerosAfterDecimal currently evaluates to double -0.0001");
        assertTrue(jsonObject.get("integerWithLeadingZeros").equals(900),"Integer does not evaluate to 900");
        assertTrue(jsonObject.getInt("integerWithLeadingZeros")==900,"Integer does not evaluate to 900");
        assertTrue(jsonObject.optInt("integerWithLeadingZeros")==900,"Integer does not evaluate to 900");
        assertTrue(jsonObject.get("integerWithAllZeros").equals(0),"Integer does not evaluate to 0");
        assertTrue(jsonObject.getInt("integerWithAllZeros")==0,"Integer does not evaluate to 0");
        assertTrue(jsonObject.optInt("integerWithAllZeros")==0,"Integer does not evaluate to 0");
        assertTrue(jsonObject.get("compositeWithLeadingZeros").equals(800.90),"Double does not evaluate to 800.90");
        assertTrue(jsonObject.getDouble("compositeWithLeadingZeros")==800.9d,"Double does not evaluate to 800.90");
        assertTrue(jsonObject.optInt("compositeWithLeadingZeros")==800,"Integer does not evaluate to 800");
        assertTrue(jsonObject.getLong("compositeWithLeadingZeros")==800,"Long does not evaluate to 800.90");
        assertTrue(jsonObject.optLong("compositeWithLeadingZeros")==800,"Long does not evaluate to 800.90");
...
//        }
        ...
        assertEquals("expecting an exception message", 
                "JSONObject[\"nonKey\"] not found.", e1.getMessage());
...
//                    e.getMessage());
//        }
        Exception e15 = assertThrows(JSONException.class, ()->{
        	jsonObject.getString("trueKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
...
//                    e.getMessage());
//        }
        Exception e16 = assertThrows(JSONException.class, ()->{
        	jsonObject.getDouble("nonKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message",
...
//                    e.getMessage());
//        }
        Exception e4 = assertThrows(JSONException.class, ()->{
        	jsonObject.getDouble("stringKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message",
...
//                    e.getMessage());
//        }
        Exception e10 = assertThrows(JSONException.class, ()->{
        	jsonObject.getLong("stringKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
...
//                    e.getMessage());
//        }
        Exception e11 = assertThrows(JSONException.class, ()->{
        	jsonObject.getJSONArray("nonKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
...
//                    e.getMessage());
//        }
        Exception e12 = assertThrows(JSONException.class, ()->{
        	jsonObject.getJSONArray("stringKey");
          fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
...
//                    e.getMessage());
//        }
        Exception e13 = assertThrows(JSONException.class, ()->{
        	jsonObject.getJSONObject("nonKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
...
//                    e.getMessage());
//        }
        Exception e14 = assertThrows(JSONException.class, ()->{
        	jsonObject.getJSONObject("stringKey");
            fail("Expected an exception");
        });
        assertEquals("Expecting an exception message", 
    ...
    public void unexpectedDoubleToIntConversion() {
        ...
        assertTrue(jsonObject.getDouble(key30) == 3,"3.0 should remain a double"); 
        assertTrue(jsonObject.getDouble(key31) == 3.1,"3.1 should remain a double"); 
        ...
        assertTrue(deserialized.getDouble(key30) == 3.0,"3.0 can still be interpreted as a double");
        assertTrue( deserialized.getDouble(key31) == 3.1,"3.1 remains a double");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void bigNumberOperations() {
        ...
        assertTrue( jsonObject0.length() == 1,"JSONObject only has 1 value");
        assertTrue(obj instanceof Integer,"JSONObject parses BigInteger as the Integer lowestBitSet");
        assertTrue(obj.equals(1),"this bigInteger lowestBitSet happens to be 1");
        ...
        assertTrue(jsonObject2.get("bigInt").equals(bigInteger),"jsonObject.put() handles bigInt correctly");
        assertTrue(jsonObject2.getBigInteger("bigInt").equals(bigInteger),"jsonObject.getBigInteger() handles bigInt correctly");
        assertTrue(jsonObject2.optBigInteger("bigInt", BigInteger.ONE).equals(bigInteger),"jsonObject.optBigInteger() handles bigInt correctly");
        assertTrue(jsonObject2.toString().equals("{\"bigInt\":123456789012345678901234567890}"),"jsonObject serializes bigInt correctly");
        assertTrue(jsonObject2.getBigDecimal("bigInt").equals(new BigDecimal(bigInteger)),"BigInteger as BigDecimal");

        
        JSONObject jsonObject3 = new JSONObject();
        jsonObject3.put("bigDec", bigDecimal);
        assertTrue(jsonObject3.get("bigDec").equals(bigDecimal),"jsonObject.put() handles bigDec correctly");
        assertTrue(jsonObject3.getBigDecimal("bigDec").equals(bigDecimal),"jsonObject.getBigDecimal() handles bigDec correctly");
        assertTrue(jsonObject3.optBigDecimal("bigDec", BigDecimal.ONE).equals(bigDecimal),"jsonObject.optBigDecimal() handles bigDec correctly");
        assertTrue(jsonObject3.toString().equals(
                "{\"bigDec\":123456789012345678901234567890.12345678901234567890123456789}"),"jsonObject serializes bigDec correctly");

        assertTrue(jsonObject3.getBigInteger("bigDec").equals(bigDecimal.toBigInteger()),"BigDecimal as BigInteger");
        /**
...
//        } catch (JSONException ignored) {}
        ...
        assertTrue( obj.equals(BigDecimal.ONE),"expected BigDecimal");
...
//        } catch (JSONException ignored) {}
        ...
        assertTrue(str.equals("123456789012345678901234567890"),"numberToString() handles bigInteger correctly");
        str = JSONObject.numberToString(bigDecimal);
        assertTrue(str.equals("123456789012345678901234567890.12345678901234567890123456789"),"numberToString() handles bigDecimal correctly");
        ...
        assertTrue(obj instanceof Number,"stringToValue() turns bigInteger string into Number");
        obj = JSONObject.stringToValue(bigDecimal.toString());
        assertTrue(obj instanceof Number,"stringToValue() changes bigDecimal Number");
        ...
        assertTrue(actualFromMapStr.equals(
                "{\"bigInt\":123456789012345678901234567890}"),"bigInt in map (or array or bean) is a string");
        // bigInt put
        JSONObject jsonObject5 = new JSONObject();
        jsonObject5.put("bigInt", bigInteger);
        String actualFromPutStr = jsonObject5.toString();
        assertTrue(actualFromPutStr.equals(
                "{\"bigInt\":123456789012345678901234567890}"),"bigInt from put is a number");
        // bigDec map ctor
        ...
        assertTrue(actualFromMapStr.equals(
                "{\"bigDec\":123456789012345678901234567890.12345678901234567890123456789}"),"bigDec in map (or array or bean) is a bigDec");
        // bigDec put
        JSONObject jsonObject7 = new JSONObject();
        jsonObject7.put("bigDec", bigDecimal);
        actualFromPutStr = jsonObject7.toString();
        assertTrue(actualFromPutStr.equals(
                "{\"bigDec\":123456789012345678901234567890.12345678901234567890123456789}"),"bigDec from put is a number");
        // bigInt,bigDec put 
        ...
        assertTrue(actualFromPutStr.equals(
                "[123456789012345678901234567890,123456789012345678901234567890.12345678901234567890123456789]"),"bigInt, bigDec from put is a number");
        assertTrue( jsonArray0.getBigInteger(0).equals(bigInteger),"getBigInt is bigInt");
        assertTrue( jsonArray0.getBigDecimal(1).equals(bigDecimal),"getBigDec is bigDec");
        assertTrue( jsonArray0.optBigInteger(0, BigInteger.ONE).equals(bigInteger),"optBigInt is bigInt");
        assertTrue( jsonArray0.optBigDecimal(1, BigDecimal.ONE).equals(bigDecimal),"optBigDec is bigDec");
...
//        } catch (Exception ignored) {}
        ...
        assertTrue( jsonArray0.optBigInteger(2, BigInteger.ONE).equals(BigInteger.ONE),"optBigInt is default");
        assertTrue( jsonArray0.optBigDecimal(2, BigDecimal.ONE).equals(BigDecimal.ONE),"optBigDec is default");
        ...
        assertTrue(actualFromListStr.equals(
                "[123456789012345678901234567890,123456789012345678901234567890.12345678901234567890123456789]"),"bigInt, bigDec in list is a bigInt, bigDec");
        // bigInt bean ctor
        ...
        assertTrue(actualFromBeanStr.contains("123456789012345678901234567890"),"bigInt from bean ctor is a bigInt");
        // bigDec bean ctor
        ...
        // can't do a full string compare because mockery adds an extra key/value
        assertTrue(actualFromBeanStr.contains("123456789012345678901234567890.12345678901234567890123456789"),"bigDec from bean ctor is a bigDec");
        // bigInt,bigDec wrap()
        obj = JSONObject.wrap(bigInteger);
        assertTrue(obj.equals(bigInteger),"wrap() returns big num");
        obj = JSONObject.wrap(bigDecimal);
        assertTrue(obj.equals(bigDecimal),"wrap() returns string");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
    ...
    public void jsonObjectNames() {
        ...
        assertTrue(null == JSONObject.getNames((Object)null),"null names from null Object");

        // getNames() from object with no fields
        assertTrue(null == JSONObject.getNames(new MyJsonString()),"null names from Object with no fields");
        ...
        assertTrue(null == JSONObject.getNames(jsonObject1),"empty JSONObject should have null names");
        ...
        assertTrue( docList.size() == 3,"expected 3 items");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='trueKey')]")).size() == 1,"expected to find trueKey");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='falseKey')]")).size() == 1,"expected to find falseKey");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='stringKey')]")).size() == 1,"expected to find stringKey");
        ...
        assertTrue( docList.size() == 3,"expected 3 items");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='VAL1')]")).size() == 1,"expected to find VAL1");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='VAL2')]")).size() == 1,"expected to find VAL2");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='VAL3')]")).size() == 1,"expected to find VAL3");
        ...
        docList = JsonPath.read(doc, "$");
        assertTrue( docList.size() == 2,"expected 2 items");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='publicString')]")).size() == 1,"expected to find publicString");
        assertTrue(((List<?>) JsonPath.read(doc, "$[?(@=='publicInt')]")).size() == 1,"expected to find publicInt");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
    ...
    public void jsonObjectNamesToJsonAray() {
        ...
        assertTrue( ((List<?>)(JsonPath.read(doc, "$"))).size() == 3,"expected 3 top level items");
        assertTrue( ((List<?>) JsonPath.read(doc, "$[?(@=='trueKey')]")).size() == 1,"expected to find trueKey");
        assertTrue( ((List<?>) JsonPath.read(doc, "$[?(@=='falseKey')]")).size() == 1,"expected to find falseKey");
        assertTrue( ((List<?>) JsonPath.read(doc, "$[?(@=='stringKey')]")).size() == 1,"expected to find stringKey");
        Util.checkJSONObjectMaps(jsonObject);
    ...
    public void jsonObjectIncrement() {
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 6,"expected 6 top level items");
        assertTrue( Integer.valueOf(3).equals(jsonObject.query("/keyInt")),"expected 3");
        assertTrue( Long.valueOf(9999999993L).equals(jsonObject.query("/keyLong")),"expected 9999999993");
        assertTrue( BigDecimal.valueOf(3.1).equals(jsonObject.query("/keyDouble")),"expected 3.1");
        assertTrue( new BigInteger("123456789123456789123456789123456781").equals(jsonObject.query("/keyBigInt")),"expected 123456789123456789123456789123456781");
        assertTrue( new BigDecimal("123456789123456789123456789123456781.1").equals(jsonObject.query("/keyBigDec")),"expected 123456789123456789123456789123456781.1");
        ...
        */
        assertFalse( (double)0.2f == 0.2d ,"Document unexpected behaviour with explicit type-casting float as double!");
        assertFalse( 0.2f == 0.2d ,"Document unexpected behaviour with implicit type-cast!");
        Double d1 = Double.valueOf( 1.1f );
        Double d2 = Double.valueOf( "1.1f" );
        assertFalse( d1.equals( d2 ) ,"Document implicit type cast from float to double before calling Double(double d) constructor");

        assertTrue( Double.valueOf( 3.1d ).equals(  Double.valueOf( Float.valueOf( 3.1f ).toString() ) ) ,"Correctly converting float to double via base10 (string) representation!");
        ...
        assertFalse( jo.get( "bug" ).equals(  Double.valueOf( 3.1d ) ) ,"The java-compiler did add some zero bits for you to the mantissa (unexpected, but well documented)");
    ...
    public void jsonObjectPut() {
        ...
        assertTrue( Boolean.TRUE.equals(jsonObject.query("/trueKey")),"expected true");
        assertTrue( Boolean.FALSE.equals(jsonObject.query("/falseKey")),"expected false");
        assertTrue( ((List<?>)(JsonPath.read(doc, "$.arrayKey"))).size() == 3,"expected 3 arrayKey items");
        assertTrue( Integer.valueOf(0).equals(jsonObject.query("/arrayKey/0")),"expected 0");
        assertTrue( Integer.valueOf(1).equals(jsonObject.query("/arrayKey/1")),"expected 1");
        assertTrue( Integer.valueOf(2).equals(jsonObject.query("/arrayKey/2")),"expected 2");
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.objectKey"))).size() == 4,"expected 4 objectKey items");
        assertTrue( "myVal1".equals(jsonObject.query("/objectKey/myKey1")),"expected myVal1");
        assertTrue( "myVal2".equals(jsonObject.query("/objectKey/myKey2")),"expected myVal2");
        assertTrue( "myVal3".equals(jsonObject.query("/objectKey/myKey3")),"expected myVal3");
        assertTrue( "myVal4".equals(jsonObject.query("/objectKey/myKey4")),"expected myVal4");

        jsonObject.remove("trueKey");
        JSONObject expectedJsonObject = new JSONObject(expectedStr);
        assertTrue(!jsonObject.similar(expectedJsonObject),"unequal jsonObjects should not be similar");
        assertTrue(!jsonObject.similar(new JSONArray()),"jsonObject should not be similar to jsonArray");
        ...
        assertTrue(!aCompareValueJsonObject.similar(bCompareValueJsonObject),"different values should not be similar");
        ...
        assertTrue(!aCompareObjectJsonObject.similar(bCompareObjectJsonObject),"different nested JSONObjects should not be similar");
        ...
        assertTrue(!aCompareArrayJsonObject.similar(bCompareArrayJsonObject),"different nested JSONArrays should not be similar");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
    ...
    public void jsonObjectToStringIndent() {
        ...
        assertEquals( jo.toString(2),"toString(2)","{\"TABLE\": {\"yhoo\": {}}}");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
                jsonObject, jo
        )));
    }
    ...
    public void jsonObjectToStringSuppressWarningOnCastToMap() {
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 1,"expected 1 top level item");
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$.key"))).size() == 1,"expected 1 key item");
        assertTrue( "def".equals(jsonObject.query("/key/abc")),"expected def");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectToStringSuppressWarningOnCastToCollection() {
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonObject.toString());
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 1,"expected 1 top level item");
        assertTrue( ((List<?>)(JsonPath.read(doc, "$.key"))).size() == 1,"expected 1 key item");
        assertTrue( "abc".equals(jsonObject.query("/key/0")),"expected abc");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void valueToString() {
        ...
        assertTrue("null".equals(JSONObject.valueToString(null)),"null valueToString() incorrect");
        MyJsonString jsonString = new MyJsonString();
        assertTrue("my string".equals(JSONObject.valueToString(jsonString)),"jsonstring valueToString() incorrect");
        assertTrue("true".equals(JSONObject.valueToString(Boolean.TRUE)),"boolean valueToString() incorrect");
        assertTrue("null".equals(JSONObject.doubleToString(Double.POSITIVE_INFINITY)),"non-numeric double");
        ...
        assertTrue(JSONObject.valueToString(jsonArray).equals(jsonArray.toString()),"jsonArray valueToString() incorrect");
        ...
        assertTrue(jsonArray.toString().equals(JSONObject.valueToString(array)),"array valueToString() incorrect");
        Util.checkJSONObjectMaps(jsonObject);
        Util.checkJSONArrayMaps(jsonArray, jsonObject.getMapType());
    }
    ...
    public void valueToStringConfirmException() {
        ...
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 1,"expected 1 top level item");
        assertTrue( "myValue".equals(JsonPath.read(doc, "$.1")),"expected myValue");
    }
    ...
    public void wrapObject() {
        ...
        assertTrue(JSONObject.NULL == JSONObject.wrap(null),"null wrap() incorrect");

        // wrap(Integer) returns Integer
        Integer in = Integer.valueOf(1);
        assertTrue(in == JSONObject.wrap(in),"Integer wrap() incorrect");
        ...
        assertTrue(bdWrap.equals(BigDecimal.ONE),"BigDecimal.ONE evaluates to ONE");
        ...
        String jsonObjectStr = 
                "{"+
                 ...
                 "}";
        JSONObject jsonObject = new JSONObject(jsonObjectStr);
        assertTrue(jsonObject == JSONObject.wrap(jsonObject),"JSONObject wrap() incorrect");
        ...
        Object doc = Configuration.defaultConfiguration().jsonProvider().parse(jsonArray.toString());
        assertTrue( ((List<?>)(JsonPath.read(doc, "$"))).size() == 3,"expected 3 top level items");
        assertTrue( Integer.valueOf(1).equals(jsonArray.query("/0")),"expected 1");
        assertTrue( Integer.valueOf(2).equals(jsonArray.query("/1")),"expected 2");
        assertTrue( Integer.valueOf(3).equals(jsonArray.query("/2")),"expected 3");
        ...
        assertTrue( ((Map<?,?>)(JsonPath.read(doc, "$"))).size() == 3,"expected 3 top level items");
        assertTrue( "val1".equals(mapJsonObject.query("/key1")),"expected val1");
        assertTrue( "val2".equals(mapJsonObject.query("/key2")),"expected val2");
        assertTrue( "val3".equals(mapJsonObject.query("/key3")),"expected val3");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
...
//                    e.getMessage());
//        }
        Exception e17 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key (level 0)
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e18 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key (level 0) holding an object
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e19 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key (level 0) holding an array
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e20 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key (level 1)
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e21 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key (level 1) holding an object
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e22 = assertThrows(JSONException.class, ()->{
        	 // test exception message when including a duplicate key (level 1) holding an array
            String str = "{\n"
                        +"    \"attr01\":\"value-01\",\n"
                        +"    \"attr02\":\"value-02\",\n"
...
//                    e.getMessage());
//        }
        Exception e23 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key in object (level 0) within an array
            String str = "[\n"
                        +"    {\n"
                        +"        \"attr01\":\"value-01\",\n"
...
//                    e.getMessage());
//        }
        Exception e24 = assertThrows(JSONException.class, ()->{
        	// test exception message when including a duplicate key in object (level 1) within an array
            String str = "[\n"
                        +"    {\n"
                        +"        \"attr01\":\"value-01\",\n"
    ...
    public void jsonObjectOptDefault() {
        ...
        assertTrue(BigDecimal.TEN.compareTo(jsonObject.optBigDecimal("myKey", BigDecimal.TEN))==0,"optBigDecimal() should return default BigDecimal");
        assertTrue(BigInteger.TEN.compareTo(jsonObject.optBigInteger("myKey",BigInteger.TEN ))==0,"optBigInteger() should return default BigInteger");
        assertTrue( jsonObject.optBoolean("myKey", true),"optBoolean() should return default boolean");
        assertTrue( jsonObject.optBooleanObject("myKey", true),"optBooleanObject() should return default Boolean");
        assertTrue(42 == jsonObject.optInt("myKey", 42),"optInt() should return default int");
        assertTrue(Integer.valueOf(42).equals(jsonObject.optIntegerObject("myKey", 42)),"optIntegerObject() should return default Integer");
        assertTrue(MyEnum.VAL1.equals(jsonObject.optEnum(MyEnum.class, "myKey", MyEnum.VAL1)),"optEnum() should return default Enum");
        assertTrue(null==jsonObject.optJSONArray("myKey"),"optJSONArray() should return null ");
        assertTrue("value".equals(jsonObject.optJSONArray("myKey", new JSONArray("[\"value\"]")).getString(0)),"optJSONArray() should return default JSONArray");
        assertTrue(jsonObject.optJSONObject("myKey", new JSONObject("{\"testKey\":\"testValue\"}")).getString("testKey").equals("testValue"),"optJSONObject() should return default JSONObject ");
        assertTrue(42l == jsonObject.optLong("myKey", 42l),"optLong() should return default long");
        assertTrue(Long.valueOf(42l).equals(jsonObject.optLongObject("myKey", 42l)),"optLongObject() should return default Long");
        assertTrue(42.3d == jsonObject.optDouble("myKey", 42.3d),"optDouble() should return default double");
        assertTrue(Double.valueOf(42.3d).equals(jsonObject.optDoubleObject("myKey", 42.3d)),"optDoubleObject() should return default Double");
        assertTrue(42.3f == jsonObject.optFloat("myKey", 42.3f),"optFloat() should return default float");
        assertTrue(Float.valueOf(42.3f).equals(jsonObject.optFloatObject("myKey", 42.3f)),"optFloatObject() should return default Float");
        assertTrue(42l == jsonObject.optNumber("myKey", Long.valueOf(42)).longValue(),"optNumber() should return default Number");
        assertTrue("hi".equals(jsonObject.optString("hiKey", "hi")),"optString() should return default string");
        Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectOptNoKey() {
         ...
         assertTrue( Integer.valueOf(42).equals(jsonObject.optIntegerObject("myKey", 42)),"optIntegerObject() should return default Integer");
         assertTrue( MyEnum.VAL1.equals(jsonObject.optEnum(MyEnum.class, "myKey", MyEnum.VAL1)),"optEnum() should return default Enum");
         assertTrue( new JSONArray("[\"value\"]")).getString(0)),"optJSONArray() should return default JSONArray","value".equals(jsonObject.optJSONArray("myKey");
         assertTrue( null==jsonObject.optJSONArray("myKey"),"optJSONArray() should return null ");
         assertTrue(jsonObject.optJSONObject("myKey", new JSONObject("{\"testKey\":\"testValue\"}")).getString("testKey").equals("testValue"),"optJSONObject() should return default JSONObject ");
         assertTrue( 42l == jsonObject.optLong("myKey", 42l),"optLong() should return default long");
         assertTrue( Long.valueOf(42l).equals(jsonObject.optLongObject("myKey", 42l)),"optLongObject() should return default Long");
         ...
         assertTrue( Float.valueOf(42.3f).equals(jsonObject.optFloatObject("myKey", 42.3f)),"optFloatObject() should return default Float");
         assertTrue( 42l == jsonObject.optNumber("myKey", Long.valueOf(42)).longValue(),"optNumber() should return default Number");
         assertTrue( "hi")),"optString() should return default string","hi".equals(jsonObject.optString("hiKey");
         Util.checkJSONObjectMaps(jsonObject);
    }
    ...
    public void jsonObjectOptStringConversion() {
        ...
        assertTrue(jo.optBoolean("true",false)==true,"unexpected optBoolean value");
        assertTrue(Boolean.valueOf(true).equals(jo.optBooleanObject("true",false)),"unexpected optBooleanObject value");
        assertTrue(jo.optBoolean("false",true)==false,"unexpected optBoolean value");
        assertTrue(Boolean.valueOf(false).equals(jo.optBooleanObject("false",true)),"unexpected optBooleanObject value");
        assertTrue(jo.optInt("int",0)==123,"unexpected optInt value");
        assertTrue(Integer.valueOf(123).equals(jo.optIntegerObject("int",0)),"unexpected optIntegerObject value");
        assertTrue(jo.optLong("int",0)==123l,"unexpected optLong value");
        assertTrue(Long.valueOf(123l).equals(jo.optLongObject("int",0L)),"unexpected optLongObject value");
        assertTrue(jo.optDouble("int",0.0d)==123.0d,"unexpected optDouble value");
        assertTrue(Double.valueOf(123.0d).equals(jo.optDoubleObject("int",0.0d)),"unexpected optDoubleObject value");
        assertTrue(jo.optFloat("int",0.0f)==123.0f,"unexpected optFloat value");
        assertTrue(Float.valueOf(123.0f).equals(jo.optFloatObject("int",0.0f)),"unexpected optFloatObject value");
        assertTrue(jo.optBigInteger("int",BigInteger.ZERO).compareTo(new BigInteger("123"))==0,"unexpected optBigInteger value");
        assertTrue(jo.optBigDecimal("int",BigDecimal.ZERO).compareTo(new BigDecimal("123"))==0,"unexpected optBigDecimal value");
        assertTrue(jo.optBigDecimal("int",BigDecimal.ZERO).compareTo(new BigDecimal("123"))==0,"unexpected optBigDecimal value");
        assertTrue(jo.optNumber("int",BigInteger.ZERO).longValue()==123l,"unexpected optNumber value");
        Util.checkJSONObjectMaps(jo);
    }
    ...
    public void toJSONArray() {
        assertTrue(null == new JSONObject().toJSONArray(null),"toJSONArray() with null names should be null");
    }
    ...
    public void testJSONWriterException() {
        ...
        try {
            ...
            assertEquals( e.getMessage(),"Unable to write JSONObject value for key: someKey");
        } catch(Exception e) {
...
*/
    ...
    public void equals() {
        ...
        assertTrue(aJsonObject.equals(aJsonObject),"Same JSONObject should be equal to itself");
    ...
    public void jsonObjectNullOperations() {
        ...
        assertTrue(obj.equals(value),"opt() JSONObject.NULL should find JSONObject.NULL");
        value = jsonObjectJONull.get("key");
        assertTrue(obj.equals(value),"get() JSONObject.NULL should find JSONObject.NULL");
        if (value == null) {
            value = "";
        }
        String string = value instanceof String ? (String)value : null;
        assertTrue(string == null,"XML toString() should convert JSONObject.NULL to null");
...
//        assertTrue( "".equals(string),"should convert null to empty string");
        try {
        ...
        assertTrue("<key>null</key>".equals(sJONull),"JSONObject.NULL should emit a null value");
        String sNull = XML.toString(jsonObjectNull);
        assertTrue( "".equals(sNull),"null should emit an empty string");
        Util.checkJSONObjectsMaps(new ArrayList<JSONObject>(Arrays.asList(
    ...
    public void toMap() {
        ...
        assertTrue( key3Val1List.get(1).equals(new BigDecimal("2.1")),"key3 list val 1 list element 2 should be 2.1");
    ...
    public void testSingletonBean() {
        ...
        assertEquals( jo2.get("someString"),"Something");
    ...
    */
    ...
    public void jsonObjectClearMethodTest() {
        assertThrows(JSONException.class, ()-> {
            ...
            assertTrue(jsonObject.length() == 0, "expected jsonObject.length() == 0"); //Check if its length is 0
